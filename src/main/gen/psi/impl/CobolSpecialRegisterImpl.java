...
public class CobolSpecialRegisterImpl extends ASTWrapperPsiElement implements CobolSpecialRegister {

  public CobolSpecialRegisterImpl(@NotNull ASTNode node) {
    super(node);
  }
