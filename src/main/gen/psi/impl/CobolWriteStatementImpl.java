...
public class CobolWriteStatementImpl extends ASTWrapperPsiElement implements CobolWriteStatement {

  public CobolWriteStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public CobolAdvancingPhrase getAdvancingPhrase() {
    return findChildByClass(CobolAdvancingPhrase.class);
  }
