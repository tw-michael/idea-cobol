...
public class CobolNumericConstantImpl extends ASTWrapperPsiElement implements CobolNumericConstant {

  public CobolNumericConstantImpl(@NotNull ASTNode node) {
    super(node);
  }
