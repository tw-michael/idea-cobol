...
public class CobolPerformVaryingClauseImpl extends ASTWrapperPsiElement implements CobolPerformVaryingClause {

  public CobolPerformVaryingClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitPerformVaryingClause(this);
  }
  ...
  public CobolPerformUntilClause getPerformUntilClause() {
    return findNotNullChildByClass(CobolPerformUntilClause.class);
  }
